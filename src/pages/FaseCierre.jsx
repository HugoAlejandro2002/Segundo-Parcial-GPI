...
function FaseCierre() {
    return (
      ...
      <h1 className='text-2xl font-bold' style={{ color: '#00377B' }}>Fase de Cierre del Proyecto CRM para TIGO</h1>
      
      <h2 className='text-xl font-bold' style={{ color: '#00377B' }}>Evaluación y Feedback</h2>
      ...
      <h2 className='text-xl font-bold' style={{ color: '#00377B' }}>Manual de Usuario</h2>
      ...
      <h2 className='text-xl font-bold' style={{ color: '#00377B' }}>Mantenimiento y Actualización</h2>
      <ul className="list-disc pl-6 text-xl font-light pb-4" style={{ color: '#717171' }}>
      ...
      <a href="https://docs.google.com/document/d/1hlOaAf08FAvx9Y05is8KDGxXpRaJbSgPT66fXNRyqFU/edit" target="_blank" rel="noreferrer">
        <h2 className="text-2xl font-bold text-left text-primary uppercase py-4" style={{ color: '#00377B' }}>Fase de Cierre</h2>
      </a>
      <a href="https://docs.google.com/document/d/11U6oHlABHv5PgiJffscBv_fFmkErrxyMn81zhL84nB0/edit" target="_blank" rel="noreferrer">
        <h2 className="text-2xl font-bold text-left text-primary uppercase py-4" style={{ color: '#00377B' }}>Carta de Entrega del Proyecto</h2>
      </a>
    </div>
    );
  }
