...
function FaseInicio() {
  ...
  return (
    <div className="container mx-auto px-10 py-8 rounded-3xl bg-slate-50" style={{ backgroundColor: 'rgba(217, 217, 217, 0.74)' }}>
      <h1 className='text-2xl font-bold' style={{ color: '#00377B' }}>Fase de Inicio del Proyecto CRM para TIGO</h1>
      ...
      <a href="https://docs.google.com/document/d/1lnXYpDph5zg_IzsjkkpAH6iaiOoOhlxW78aKPsb8hqU" target="_blank" rel="noreferrer">
        <h2 className="text-2xl font-bold text-left text-primary uppercase py-4" style={{ color: '#00377B' }}>Ishikawa</h2>
      </a>
      ...
      <h2 className='text-xl font-bold' style={{ color: '#00377B' }}>Límites y Alcances</h2>
      ...
      <a href="https://docs.google.com/document/d/1kkkwFm4oVtM7q4DWBURxmzV4wEk5oB_qlLzK4KUayIE/edit" target="_blank" rel="noreferrer">
        <h2 className="text-2xl font-bold text-left text-primary uppercase py-4" style={{ color: '#00377B' }}>Limites y Alcance</h2>
      </a>

      <h2 className='text-xl font-bold' style={{ color: '#00377B' }}>Estrategia de Implementación</h2>
      <ul className="list-disc pl-6 text-xl font-light pb-4" style={{ color: '#717171' }}>
      ...
      <a href="https://docs.google.com/document/d/1xPzpSPTthH6z1mFiel6cKxumysJxxQrbc8tfWcW7Es4/edit" target="_blank" rel="noreferrer">
        <h2 className="text-2xl font-bold text-left text-primary uppercase py-4" style={{ color: '#00377B' }}>TDR</h2>
      </a>
      <a href="https://docs.google.com/document/d/1-obTmJ7r2aVal62OtEyIlBzfNBhH70iNCGl0mtuB88Y/edit" target="_blank" rel="noreferrer">
        <h2 className="text-2xl font-bold text-left text-primary uppercase py-4" style={{ color: '#00377B' }}>Carta de Inicio</h2>
      </a>
    </div>
  );
}
