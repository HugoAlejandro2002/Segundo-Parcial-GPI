  ...
  return (
    <div className="container mx-auto px-4">
      ...
      <div className="flex justify-center">
        <button
          className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full mb-8 text-xl"
        >
          <a
      ...
      <h2 className="text-2xl font-bold text-center pb-8 pt-14" style={{ color: "#00377B" }}>
        DIAGRAMA BPWIN
      </h2>
      <div
        style={{
      ...
      <h2 className="text-2xl font-bold text-center pb-8" style={{ color: "#00377B" }}>
        MOCKUPS
      </h2>
      <div
        style={{
