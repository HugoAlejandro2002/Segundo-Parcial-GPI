...
function FaseControlCalidad() {
  return (
    <div className="container mx-auto px-10 py-8 rounded-3xl bg-slate-50" style={{ backgroundColor: 'rgba(217, 217, 217, 0.74)' }}>
      <h1 className='text-2xl font-bold' style={{ color: '#00377B' }}>Fase de Control de Calidad </h1>
      ...
      <h1 className='text-2xl font-bold' style={{ color: '#00377B' }}>Fase de Implementación</h1>
      <br />
      <h3 className='text-xl font-bold' style={{ color: '#00377B' }}>Arquitectura del sistema web:</h3>
      <p className='text-justify mt-2' style={{ color: '#717171' }}>
